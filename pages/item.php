...
<body>
	...
	<section class="row">
		...
		<div class="main70">
			...
			<button onclick="document.getElementById('edit-listing-popup').style.display='block'" class="edit-button" aria-label="profile settings">
				...
				<div class="item-general">
					...
					<div class="status">
						<table>
							...
							<tr>
								<th>Gender</th>
								<td><?= $dog_data['gender_name'] ?></td>
							</tr>
							<tr>
								<th>Breed</th>
								<td><?= $dog_data['breed_name'] ?></td>
							</tr>
							<tr>
								<th>Color</th>
								<td><?= $dog_data['color_name'] ?></td>
							</tr>
							<tr>
								<th>Age</th>
								<td><?= $dog_data['age_name'] ?></td>
							</tr>
						</table>
						</div>
					</div>
					<div class="item-more">
						<?php if(isset($_SESSION['id']) && $_SESSION['id'] == $dog_data['user_id']) {
